...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="index.php" class="brand-link">
    <img src="dist/img/brokofie-logo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    <span class="brand-text font-weight-light">SiropetCafé</span>
  </a>
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <div class="info">
        <a href="#" class="d-block">Hanna - Nisah</a>
      </div>
    </div>
